...
const assignToManager = async (adminUser: JwtPayload, userId: string, scopeId: string) => {
    if (adminUser.role !== UserRole.ADMIN) {
        throw new AppError(StatusCodes.FORBIDDEN, "Only admins can assign users to managers.");
    }
